...
- **5 browser suites, 114 checks** (`python tests/e2e/run.py`) that load the **real unpacked extension** into headless Edge and drive it over the DevTools protocol against fixture pages that stand in for the console.
