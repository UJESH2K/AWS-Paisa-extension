...
| | State |
|---|---|
| Extension (button, panel, badges, popup) | Built. `dist/paisa-extension-0.7.0.zip` |
...
| Tests | 101 backend (98% coverage), 144 browser checks across 6 suites. All green locally |
...
python tests/e2e/run.py                               # 6 browser suites (144 checks)
