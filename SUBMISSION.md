...
| | State |
|---|---|
| Extension (button, panel, badges, popup) | Built. `dist/paisa-extension-0.6.0.zip` |
...
| Tests | 101 backend (98% coverage), 142 browser checks across 6 suites. All green locally |
...
python tests/e2e/run.py                               # 6 browser suites (142 checks)
